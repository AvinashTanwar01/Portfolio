...
const Work = ({ isDarkMode, setIsDarkMode }) => {
  return (
    ...
    >
      ...
      >
        Welcome to my project showcase! Here are some of my latest works,
        including web design, mobile apps, and more. I specialize in creating
        responsive, user-friendly applications that deliver seamless digital
        experiences.
      </motion.p>
